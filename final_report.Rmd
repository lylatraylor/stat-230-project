...
```{r fig:myimage1, echo=FALSE, fig.cap="Fitted line plot for held-out test set for ridge regression.", out.width="75%", fig.align="center", fig.pos='H'}
...
```{r fig:myimage2, echo=FALSE, fig.cap="Residual plot for ridge regression.", out.width="70%", fig.align="center", fig.pos='H'}
knitr::include_graphics("report_figs/ridge_resid.png")
```

For our final model (ridge regression), we constructed 90% conformal prediction intervals to quantify predictive uncertainty for each observation in the testing set (Fig. 3). Conformal prediction is appropriate in this setting because it is distribution-free and does not rely on assumptions such as homoskedasticity, instead requiring only that the data are exchangeable. In this application, the conformal prediction intervals are primarily useful for understanding the limits of predictive accuracy, rather than for directly supporting decision-making of forest managers. 

```{r fig:myimage3, echo=FALSE, fig.cap="Fitted line plot for held-out test set with conformal prediction intervals.", out.width="70%", fig.align="center", fig.pos='H'}
...
```{r fig:myimage4, echo=FALSE, fig.cap="Residual plot for LASSO regression.", out.width="70%", fig.align="center", fig.pos='H'}
...
```{r fig:myimage6, echo=FALSE, fig.cap="Fitted line plot for held-out test set for LASSO regression.", out.width="70%", fig.align="center", fig.pos='H'}

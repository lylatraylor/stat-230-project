...
The LASSO model selected 22 variables (i.e., non-zero coefficients; Fig. 5), including site, five summary metrics on the 0-3 m high voxelized point clouds with tree stems and shrubs removed, four summary metrics on the entire voxelized point cloud, five summary metrics on points classified as trees, and seven summary metrics on points classified as shrubs. 
...
Connot, J., and K. Nelson (2026). *Interagency Ecosystem LiDAR Monitoring (IntELiMon).* US Geological Survey, Earth Resources Observation and Science (EROS) Center.  
...
Kea Rutherford gathered and organized the necessary data, wrote the code for the LASSO regression, and wrote the first full draft of the report. 

Lyla Traylor wrote the code for the ridge regression (including the code for the conformal prediction intervals) and edited the report.
